...
import { youtubeApi, type Song as ApiSong, type YouTubeMetadata } from "./songs";
import "./styles.css";

type Song={id?:string;youtubeVideoId?:string|null;title:string;artist:string;note:string;image:string};
const songs:Song[]=[
